...
def load_workflow_configuration():
    ...
    if config_path and os.path.isfile(config_path):
        with open(config_path) as json_file:
            ...
            # Assuming you want to register the workflow states in CKAN
            for workflow_name, workflow_data in workflow_config['workflows'].items():
        ...
        toolkit.log.error("Workflow configuration file not found: %s", config_path)
